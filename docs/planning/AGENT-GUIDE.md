...
<!-- AI: When a user clones this template for their project, they should fill in this section. Until then, these are instructional placeholders. -->

### What is [PROJECT_NAME]?
<!-- AI: Replace this section with a 2-3 sentence description of the project. Include: what problem it solves, who it's for, and what makes it unique. Example structure: "[PROJECT_NAME] is a [type of application] that helps [target users] to [primary benefit]. It [key differentiator]." -->

[Brief description of your project - fill this in after cloning the template]

### Core Concept
<!-- AI: Describe the fundamental idea behind the application. What are the 2-3 main concepts a new developer needs to understand? What mental model should they have? -->

### Tech Stack
- **Framework**: [Defined in doc 07]
- **Frontend**: [Defined in doc 07]
- **Styling**: [Defined in doc 16]
- **State**: [Defined in doc 08]
- **External APIs**: [Defined in doc 09]
